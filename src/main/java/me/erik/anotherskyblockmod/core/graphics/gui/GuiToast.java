...
public class GuiToast extends Gui {
    ...
    public <T extends IToast> T getToast(Class<? extends T> clazz, Object obj) {
        ...
        for (GuiToast.ToastInstance<?> instance : this.visible) {
            if (instance != null && clazz.isAssignableFrom(instance.getToast().getClass()) && instance.getToast().getType().equals(obj)) {
