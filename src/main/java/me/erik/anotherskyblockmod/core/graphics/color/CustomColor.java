...
import me.erik.anotherskyblockmod.util.MathUtils;
...
public class CustomColor {
     ...
     */
    public static CustomColor fromInt(int argb) { return fromInt(argb & 0xFFFFFF, ((argb >>> 24) & 0xFF) / 255f); }
     ...
     */
    public static CustomColor fromInt(int rgb, float a) { return fromBytes((byte) (rgb >>> 16), (byte) (rgb >>> 8), (byte) rgb, a); }
    
    public static CustomColor fromBytes(byte r, byte g, byte b) { return fromBytes(r, g, b, 0); }
    
    public static CustomColor fromBytes(byte r, byte g, byte b, byte a) { return fromBytes(r, g, b, Byte.toUnsignedInt(a) / 255f); }
    ...
    @Override
    public String toString() { return "rgba(" + r + "," + g + "," + b + "," + a + ")"; }
    ...
    @Override
    public int hashCode() { return Arrays.hashCode(new float[]{r, g, b, a}); }
    
    static class SetBase extends CustomColor {
        
        SetBase(int rgb) { super((rgb >> 16) / 255.f, ((rgb >> 8) & 0xFF) / 255.f, (rgb & 0xFF) / 255.f, 1); }
        
        SetBase(float r, float g, float b, float a) { super(r, g, b, a); }
