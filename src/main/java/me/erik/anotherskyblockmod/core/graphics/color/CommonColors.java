...
public class CommonColors extends CustomColor.SetBase {
    ...
    private static final CommonColors[] colors = {BLACK, RED, GREEN, BLUE, YELLOW, BROWN, PURPLE, CYAN, LIGHT_GRAY, GRAY, PINK, LIGHT_GREEN, LIGHT_BLUE, MAGENTA, ORANGE, WHITE};
    private static final String[] names = {"BLACK", "RED", "GREEN", "BLUE", "YELLOW", "BROWN", "PURPLE", "CYAN", "LIGHT_GRAY", "GRAY", "PINK", "LIGHT_GREEN", "LIGHT_BLUE", "MAGENTA", "ORANGE", "WHITE"};
